"""Step 11: model-driven app + sitemap for the Case Process Configurator."""
import uuid
import dv

P = dv.PREFIX
APP_UNIQUE = f"{P}_ProcessConfiguratorApp"
APP_NAME = "Case Process Configurator"

AREAS = [
    ("Configuration", "Configuration", [
        ("Process Templates", f"{P}_caseprocesstemplate"),
    ...
    ("Runtime", "Runtime", [
        ...
        ("Required Documents", f"{P}_caserequireddocument"),
        ("Tasks", "task"),
    ]),
    ("Service Setup", "Setup", [
        ("SLAs", "sla"),
