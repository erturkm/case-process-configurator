...
{
    /// <summary>
    /// Custom API cpc_GetProcessGraph. Returns everything the visual designer needs for one template
    ...
    public class GetProcessGraph : IPlugin
    {
        ...
        public void Execute(IServiceProvider sp)
        {
            ...
            var t = svc.Retrieve(P + "caseprocesstemplate", templateId, new ColumnSet(true));
            ...
            var prio = t.GetAttributeValue<OptionSetValue>(P + "setcasepriority");
            NumField(sb, "setCasePriority", prio == null ? 0 : prio.Value);
            DecField(sb, "firstResponseHours", t.GetAttributeValue<decimal?>(P + "firstresponsehours"));
            DecField(sb, "resolutionHours", t.GetAttributeValue<decimal?>(P + "resolutionhours"));
            ...
            foreach (var o in outcomes.OrderBy(x => x.GetAttributeValue<int?>(P + "sequence") ?? 0))
            {
                ...
                var pr = o.GetAttributeValue<OptionSetValue>(P + "setcasepriority");
                ...
                BoolField(sb, "closeCase", o.GetAttributeValue<bool>(P + "closecase"));
                ...
                NumField(sb, "setCasePriority", pr == null ? 0 : pr.Value);
                sb.Append("}");
            }
            sb.Append("]");
