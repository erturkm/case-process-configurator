...
def upload():
    ...
    if wr:
        ...
        wid = dv.new_id(dv.post("webresourceset", {
            "name": WR_NAME,
            "displayname": "Case Process Outcome Picker",
...
SECTIONS = (
    ...
    '<labels><label description="Case process" languagecode="1033" /></labels>'
    '<rows>'
    ...
    '<control id="WebResource_cpcoutcome" classid="{{9FDF5F91-88B1-47f4-AD53-C11EFC01A01D}}">'
    ...
    '</control></cell></row>'
    '</rows></section>'
    '<section name="cpc_journal_sec" id="{secid2}" IsUserDefined="0" locklevel="0" '
...
def strip_old(xml):
    ...
    for sec in ("cpc_outcome_sec", "cpc_journal_sec"):
