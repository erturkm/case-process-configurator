...
if __name__ == "__main__":
    M = {t: meta(P + "_" + t) for t in
         ["caseprocesstemplate", "matchrule", "processtask", "documentpackage",
          "documentitem", "appliedprocess", "caserequireddocument"]}

    # ---------------------------------------------------------------- views first (needed by subgrids)
    print("Views")
    set_view(P + "_caseprocesstemplate", "Active Case Process Templates",
    ...
    set_view(P + "_appliedprocess", "Active Applied Processes",
             [f"{P}_name", f"{P}_case", f"{P}_template", f"{P}_appliedon", f"{P}_result",
    ...
    set_view(P + "_caserequireddocument", "Active Case Required Documents",
             [f"{P}_name", f"{P}_case", f"{P}_mandatory", f"{P}_received",
    ...
    print("Forms")
    m = M["caseprocesstemplate"]
    set_main_form(P + "_caseprocesstemplate", [
        tab("General", [
        ...
        tab("Process and Tasks", [
            section("Business process flow", [
                ...
                cell(m, f"{P}_bpfentityname"), cell(m, f"{P}_setcasepriority"),
            ]),
            section("Task plan",
        ...
        tab("SLA and Documents", [
            section("Case SLA", [cell(m, f"{P}_sla"), cell(m, f"{P}_entitlement"),
                                 cell(m, f"{P}_firstresponsehours"), cell(m, f"{P}_resolutionhours")]),
    ...
    set_main_form(P + "_appliedprocess", [tab("General", [
        section("Result", [cell(m, f"{P}_name"), cell(m, f"{P}_case"),
    ...
    m = M["caserequireddocument"]
    set_main_form(P + "_caserequireddocument", [tab("General", [
        section("Document", [cell(m, f"{P}_name"), cell(m, f"{P}_case"),
