...
APIS = [
    ("GetProcessCatalog", "Get Process Catalog", "Cpc.Plugins.GetProcessCatalog", "",
     [], [("Catalog", 14)]),
    ("AuthorProcess", "Author Process", "Cpc.Plugins.AuthorProcess", "",
     [("ProcessJson", 14, True), ("Mode", 10, False)],
     [("Summary", 14), ("TemplateId", 10), ("WarningCount", 5)]),
    ("GetProcessGraph", "Get Process Graph", "Cpc.Plugins.GetProcessGraph", "",
     [("TemplateId", 10, True)], [("Graph", 14)]),
    ("SaveProcessGraph", "Save Process Graph", "Cpc.Plugins.SaveProcessGraph", "",
     [("Graph", 14, True)], [("TemplateId", 10), ("Summary", 14)]),
    ("TestMatchRules", "Test Match Rules", "Cpc.Plugins.TestMatchRules", "",
     [("Rules", 14, True)], [("Result", 14)]),
    ("GetCaseView", "Get Case View", "Cpc.Plugins.GetCaseView", "",
     [("CaseId", 10, True)], [("View", 14)]),
]
...
def main():
    ...
    t_advance = register_type(asm, "Cpc.Plugins.AdvanceProcess", "Advance Process On Outcome")
    ...
    register_step(t_advance, "Update", "task", 40, 0,
                  "CPC: Advance process on task outcome", rank=15,
                  filtering="statecode,statuscode,cpc_selectedoutcome,cpc_outcomelabel")
