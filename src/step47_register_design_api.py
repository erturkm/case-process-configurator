...
Registers:
  cpc_DesignProcess  read an uploaded SOP and design a case process with Azure AI Foundry
...
APIS = [
    ("DesignProcess", "Design Process From Document", "Cpc.Plugins.DesignProcess", "",
