...
Adds the cpc_taskoutcome table, canvas layout columns on cpc_processtask, and the runtime
...
OUTCOME_COLS = [
    ...
    dict(name="closecase", display="Resolve The Case", type="bool", true="Resolve", false="No"),
...
def relationships():
    rels = [
        ...
        (f"{P}_taskoutcome", f"{P}_template", "Case Process Template", f"{P}_caseprocesstemplate"),
    ]
